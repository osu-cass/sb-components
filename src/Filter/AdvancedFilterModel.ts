import { SubjectModel, SearchAPIParamsModel } from '../ItemSearch/ItemSearchModels';
...
export function parseAdvancedFilter(
    filterModels: FilterCategoryModel[]): { [key: string]: string[] | undefined } {

    let queryObject: { [key: string]: string[] | undefined } = {};
    for (const fg of filterModels) {
        const selectedOptions: string[] = fg.filterOptions
...
export function advancedFilterToSearch(filterModels: FilterCategoryModel[]): SearchAPIParamsModel {
