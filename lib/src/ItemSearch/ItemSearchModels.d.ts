...
export declare type SearchFilterStringTypes = SubjectModel | InteractionTypeModel | SearchBaseModel;
export declare type SearchFilterTypes = SearchFilterStringTypes | TargetModel | GradeLevels | ClaimModel;
export declare type SearchFilterModelTypes = FilterSearchGradeLevelModel | FilterSearchStringModel<SearchFilterStringTypes> | FilterSearchTargetModel | FilterSearchClaimModel;
...
export interface FilterSearchStringModel<T extends SearchFilterStringTypes> extends FilterSearchModel {
    filterOptions: T[];
    code: FilterType.InteractionType | FilterType.Subject | FilterType.TechnologyType | FilterType.Calculator;
}
