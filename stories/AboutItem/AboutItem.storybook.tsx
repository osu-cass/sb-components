...
storiesOf("About Item Modal", module)
  ...
  .add("showing rubrics", () => (
    <AboutItem {...AboutItemMockModel} showModal={true} sampleItemScoring={{rubrics: rubrics}} />
  ))
  .add("showing rubrics ESN", () => (
    <AboutItem {...AboutItemMockModel} showModal={true} sampleItemScoring={{rubrics: rubricsEsn}} />
  ))
  .add("showing rubrics ENU ESN", () => (
    <AboutItem {...AboutItemMockModel} showModal={true} sampleItemScoring={{rubrics: allRubrics}} />
  ));
