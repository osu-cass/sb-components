            ...
            accessibilityResources: [
                {
                    ...
                    description: 'This tool is used for making notes about an item. The digital notepad is item specific and is available through the end of the test segment. Notes are not saved when the student moves on to the next segment or after a break of more than 20 minutes. (EMBEDDED)',
                    disabled: false
                },
                {
                ...
                },
                {
                    ...
                    label: 'Highlighter',
                    description: 'A digital tool for marking desired text, item questions, item answers, or parts of these with a color. Highlighted text remains available throughout each test segment. (EMBEDDED)',
                    disabled: false
                },
                {
                ...
                },
                {
                    ...
                    currentSelectionCode: 'TDS_Dict_SD3',
                    order: 16,
                    defaultSelection: 'TDS_Dict_SD3',
                    selections: [
                        {
                            selectionCode: 'TDS_Dict_SD2',
                            label: 'Merriam Webster Elementary Dictionary on',
                            order: 1,
                            disabled: true,
                            hidden: true
                        },
                ...
                },
                {
                    ...
                    description: 'Each passage or stimulus can be expanded so that it takes up a larger portion of the screen. (EMBEDDED)',
                    disabled: false
                },
                {
                ...
                },
                {
                    ...
                    label: 'Strikethrough',
                    description: 'Allows users to cross out answer options. If an answer option is an image, a strikethrough line will not appear, but the image will be grayed out. (EMBEDDED)',
                    disabled: false
                },
                {
                    ...
                    label: 'Thesaurus',
                    description: 'A thesaurus contains synonyms of terms while a student interacts with text included in the assessment. A full write is the second part of a performance task. The use of this universal tool may result in the student needing additional overall time to complete the assessment.',
                    disabled: true
                },
                {
        ...
        },
        {
            ...
            accessibilityResources: [
                ...
                },
                {
                    ...
                    currentSelectionCode: 'TDS_Masking0',
                    order: 6,
        ...
        },
        {
            ...
            accessibilityResources: [
                ...
                },
                {
                    ...
                    description: 'Layout with stimulus displayed above and items displayed below. All tool and navigation buttons are on the bottom of the screen. Important: The streamlined interface is not intended to be tablet compatible.',
                    disabled: false
                }
            ]
        }
    ] as AccResourceGroupModel[],
