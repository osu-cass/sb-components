...
import { Rubric } from "../../src/Rubric/Rubric";
...
storiesOf( "Rubric", module )
    .add( "with an empty model", () => <Rubric language="English" rubricEntries={[]} samples={[]} /> )
