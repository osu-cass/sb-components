import { AccResourceGroupModel, AccessibilityResourceModel, DropDownSelectionModel, DropdownProps, ItemAccessibilityModalProps } from '../../src';
import { action } from '@storybook/addon-actions';


export const accessibilityNotepad: AccessibilityResourceModel =
    {
        resourceCode: "DigitalNotepad", currentSelectionCode: "TDS_SCNotepad",
        order: 1, defaultSelection: "TDS_SCNotepad", disabled: false,
        description: "Digital Notepad", label: "Digital Notepad",
        selections: [
            {
...
export const accessibilityEnglishGlossary: AccessibilityResourceModel =
    {
        resourceCode: "EnglishGlossary", currentSelectionCode: "TDS_WL_0",
        order: 1, defaultSelection: "TDS_WL_Glossary", disabled: false,
        description: "English Glossary", label: "English Glossary",
        selections: [
            {
...
export const dropDisabledAllSelectionsProp: DropdownProps = {
    ...dropDefaultProp,
    updateSelection: action("Updated Selection"),
    selections: dropDefaultProp.selections.map(s => {return {...s, disabled: true}})    
}
